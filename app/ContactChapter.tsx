      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        >
          ...
          <div className="relative bg-linear-to-br from-[#f4e8d0] via-[#e8d7ba] to-[#d4c5a9] dark:from-[#4e342e]/20 dark:via-[#5d4037]/10 dark:to-[#4e342e]/20 shadow-2xl overflow-hidden backdrop-blur-sm border-4 border-[#c9a961]/50 dark:border-[#8b6f47]/30">
            ...
            {/* Letter Header with ornamental border */}
                ...
                >
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="h-12 border-b-2 border-[#c9a961]/30 dark:border-[#8b6f47]/30 w-64 relative">
                        <p className="absolute bottom-2 left-0 text-[#8b6f47]/50 dark:text-[#c9a961]/50 font-serif italic text-sm">
                          (Signature)
                        </p>
                      </div>
                    </div>
        ...
        {/* Footer Quote with vintage ornaments */}
        <motion.div
          initial={{ opacity: 0 }}
